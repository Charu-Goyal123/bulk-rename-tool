...
#             counter += 1
#
# rename_files(r"C:\Users\Luffy\Desktop\TestDir", ".*[0-9].*", "number")
#
#
...
class MyGui(QMainWindow):
    ...
    def remove_selection(self):
        try:
            if len(self.selectView.selectedIndexs()) != 0:
                for index in reversed(sorted(self.selectView.selectedIndexs())):
